...
storeL_jc   (A <c> B) (x\ (L x) <c> (D x)) (x\ (I x) <i> (J x))
                                              :- storeL_jc A L I,  storeL_jc B D J.
decideL_je  (A <c> B) (C <c> D) (I <i> J)     :- decideL_je A C I, decideL_je B D J.
releaseL_je (A <c> B) (C <c> D)               :- releaseL_je A C,  releaseL_je B D.
decideR_je  (A <c> B) (C <c> D) (I <i> J)     :- decideR_je A C I, decideR_je B D J.
storeR_jc   (A <c> B) (x\ (L x) <c> (D x)) (x\ (I x) <i> (J x))
                                              :- storeR_jc A L I,  storeR_jc B D J.
...
false_jc    (A <c> B)                         :- false_jc A,       false_jc B.
