...
type idx             form -> index.
typeabbrev assoc     list (pair i i).     % Association of client/kernel treatments of universal quantifiers
...
type astate            assoc -> list form -> context -> context    -> cert.
type dstate            assoc -> list form -> context -> context    -> cert.
type sstate            assoc -> list form -> context -> form -> et -> cert.
